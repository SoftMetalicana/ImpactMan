namespace ImpactMan.Models.Units
{
    ...
    /// <summary>
    /// Everything seen in the map/console is an unit.
    ...
    public abstract class GameplayUnit : IGameplayUnit
    {
        ...
        /// <param name="keyboardState">Info about the keyboard state. Can be taken from the Engine or the InputListener.</param>
